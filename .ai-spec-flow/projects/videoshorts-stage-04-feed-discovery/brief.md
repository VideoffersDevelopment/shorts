# Brief: Feed + Discovery

> **ŹRÓDŁO:** `.ai-project-planner/projects/videoshorts/stages/stage-04-feed-discovery/spec.md`
> **Import:** 2026-01-01
> **Status:** Synchronized
...
<!--
  Ten plik jest referencją do oryginalnego spec.md z AI Project Planner.
  Dla pełnej specyfikacji zobacz źródło powyżej.

  UWAGA: Zmiany powinny być wprowadzane w oryginalnym pliku spec.md,
  a następnie re-importowane komendą: /ai-import-stage videoshorts 4 --force
-->
