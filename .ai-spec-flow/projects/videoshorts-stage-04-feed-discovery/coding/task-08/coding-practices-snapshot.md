...
**Files:** `src/lib/locales/{pl,en,de,es,ru}/[feature].json`
...
<!-- FIX-XX rules added here - max 3 lines each -->

---

## 🚨 Recent Rules (Auto-Added)

<!-- AUTO-SYNC: Rules added by Coding Practices Updater -->
<!-- Keep this section under 20 lines - summary only -->
