...
describe('POST /api/companies/logo', () => {
  ...
  describe('Happy Path', () => {
    it('returns presigned URL for authenticated company user with JPEG', async () => {
      ...
      mockGetPublicUrl.mockReturnValue('https://cdn.example.com/companies/company-1/logo-test-nanoid-123.jpeg')

      const req = new NextRequest('http://localhost:3000/api/companies/logo', {
        method: 'POST',
      ...
      expect(data.publicUrl).toBe('https://cdn.example.com/companies/company-1/logo-test-nanoid-123.jpeg')

      expect(mockGetUploadUrl).toHaveBeenCalledWith({
        key: 'companies/company-1/logo-test-nanoid-123.jpeg',
        contentType: 'image/jpeg',
      })
      expect(mockGetPublicUrl).toHaveBeenCalledWith('companies/company-1/logo-test-nanoid-123.jpeg')
    })
    ...
    it('returns presigned URL for PNG image', async () => {
      ...
      mockGetUploadUrl.mockResolvedValue('https://r2.example.com/presigned-url')
      mockGetPublicUrl.mockReturnValue('https://cdn.example.com/companies/company-1/logo-test-nanoid-123.png')
    ...
    it('returns presigned URL for WebP image', async () => {
      ...
      mockGetUploadUrl.mockResolvedValue('https://r2.example.com/presigned-url')
      mockGetPublicUrl.mockReturnValue('https://cdn.example.com/companies/company-1/logo-test-nanoid-123.webp')
...
describe('DELETE /api/companies/logo', () => {
  ...
  describe('Happy Path', () => {
    it('deletes logo from R2 when logo exists', async () => {
      // Arrange
      mockAuth.mockResolvedValue({
        user: { id: 'user-1', email: 'test@example.com' },
        expires: new Date(Date.now() + 86400000).toISOString(),
      ...
      mockPrisma.companyProfile.findUnique.mockResolvedValue({
        ...
        categoryId: null,
        socialLinks: null,
        logo: 'https://cdn.example.com/companies/company-1/logo-123.jpg',
        banner: null,
        latitude: null,
        longitude: null,
        businessHours: null,
      ...
      expect(mockDeleteObject).toHaveBeenCalledWith('companies/company-1/logo-123.jpg')
    })
    ...
    it('extracts correct key from different URL formats', async () => {
      ...
      mockPrisma.companyProfile.findUnique.mockResolvedValue({
        ...
        categoryId: null,
        socialLinks: null,
        logo: 'https://different-cdn.com/companies/company-1/logo-456.png',
        banner: null,
        latitude: null,
        longitude: null,
        businessHours: null,
      ...
      // Assert
      expect(mockDeleteObject).toHaveBeenCalledWith('companies/company-1/logo-456.png')
    })
  })
  ...
  describe('Not Found Errors', () => {
    it('returns 404 when company has no logo', async () => {
      // Arrange
      mockAuth.mockResolvedValue({
        user: { id: 'user-1', email: 'test@example.com' },
        expires: new Date(Date.now() + 86400000).toISOString(),
  ...
  describe('Edge Cases', () => {
    it('handles logo URL with query parameters', async () => {
      // Arrange
      mockAuth.mockResolvedValue({
        user: { id: 'user-1', email: 'test@example.com' },
        expires: new Date(Date.now() + 86400000).toISOString(),
      ...
      mockPrisma.companyProfile.findUnique.mockResolvedValue({
        ...
        categoryId: null,
        socialLinks: null,
        logo: 'https://cdn.example.com/companies/company-1/logo-789.jpg?v=123',
        banner: null,
        latitude: null,
        longitude: null,
        businessHours: null,
      ...
      expect(mockDeleteObject).toHaveBeenCalledWith('companies/company-1/logo-789.jpg?v=123')
    })
  })
})
