...
export function MainContent({ children, className }: MainContentProps) {
  ...
  return (
    ...
    >
      <div className="w-full px-4 md:px-6 lg:px-8 py-6 pb-[77px] has-[[data-full-bleed]]:!p-0 has-[[data-full-bleed]]:h-[calc(100vh-4rem-53px)] has-[[data-full-bleed]]:overflow-hidden">
        {children}
      </div>
    </main>
  )
